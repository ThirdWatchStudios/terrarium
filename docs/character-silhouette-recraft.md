...
Canonical-source follow-up (2026-08-02): Bob, Short, Bun, Ponytail, Long straight, Balding, Pixie, and Side-part are now the first eight
...
and all eight former path builders are removed. Bun retains separate declarative
...
separate side/rear mass, and source-owned parting crease. The two remaining completion styles retain their
