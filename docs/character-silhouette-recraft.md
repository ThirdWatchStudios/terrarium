...
Canonical-source follow-up (2026-08-02): Bob, Short, Bun, Ponytail, Long straight, Balding, and Pixie are now the first seven
...
and all seven former path builders are removed. Bun retains separate declarative
...
broken cap/fringe and directional tufts. The three remaining completion styles retain their
