...
Canonical-source follow-up (2026-08-02): Bob, Short, Bun, and Ponytail are now the first four
...
and all four former path builders are removed. Bun retains separate declarative
cap and knot frames; Ponytail retains an independently fitted cap plus a shared
tie/tail attachment transform. The six remaining completion styles retain their
