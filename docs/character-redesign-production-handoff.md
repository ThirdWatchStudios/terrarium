...
or animation state. Bob and Short canonical SVGs now own their six
production-head fits through build-time declarative envelopes; the other eight
...
production compositor, and restores the original references. Bob and Short now
both consume build-time SVG-derived head variants with no replacement path
builder. The head-gap proof is historical evidence for the promoted sources and
