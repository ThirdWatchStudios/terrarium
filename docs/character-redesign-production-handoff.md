...
or animation state. Bob, Short, Bun, Ponytail, Long straight, and Balding canonical SVGs now own their six
production-head fits through build-time declarative envelopes; the other four
...
Long straight, and Balding consume build-time SVG-derived head variants with no replacement path
...
fits its tapered temple, rear, and horseshoe components independently. The head-gap
