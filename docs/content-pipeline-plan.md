...
7. **Representative hair-family source batch**: `hair-short`, the approved
   ...
   2026-07-10.
   Bob, Short, Bun, and Ponytail completed the first four production source-authority
   ...
   cap independently while its tie and tail share one attachment transform. All
   four old path builders are removed; the other six accepted fits remain code-owned
   migration backlog.
