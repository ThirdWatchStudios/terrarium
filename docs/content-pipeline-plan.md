...
7. **Representative hair-family source batch**: `hair-short`, the approved
   ...
   2026-07-10.
   Bob, Short, Bun, Ponytail, Long straight, Balding, Pixie, and Side-part completed the first eight production source-authority
   ...
   independently from its side/rear mass. All eight old path builders are removed; the other two accepted fits remain code-owned
   migration backlog.
