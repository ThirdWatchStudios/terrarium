# Canonical Balding production validation v2

Post-approval validation for the sixth source-owned fitted hairstyle. The production resolver must remain identical to an independent fit of the three canonical Balding SVG facings through the declarative temple, rear-piece, and horseshoe component frames.
