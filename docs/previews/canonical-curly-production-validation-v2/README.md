# Canonical Curly production validation v2

Post-approval validation for the ninth source-owned fitted hairstyle. The production resolver must remain identical to an independent fit of the three canonical Curly SVG facings through the declarative per-lobe component frames.
