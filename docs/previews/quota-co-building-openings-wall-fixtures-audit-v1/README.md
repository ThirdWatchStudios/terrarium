...
Terrarium production scale correction and the user-run export/import are complete. Unity runtime review
accepted both wall axes and handedness, one-cell wall replacement, and preservation of the floor tile beneath
the doorway. This checkpoint records the approved source, generated receiver, and runtime-consumer changes.
