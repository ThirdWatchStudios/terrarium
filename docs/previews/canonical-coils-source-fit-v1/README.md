# Canonical Coils source-fit proof v1

Review-only comparison of the current code-built Coils with a proposal derived solely from three editable SVG facings and declarative per-lobe component frames. Production remains unchanged.
