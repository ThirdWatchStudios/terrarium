...
Status: **active; P0 department machines plus Bob/Short/Bun/Ponytail source authority complete locally**
...
The hair base SVGs are checked in. The first four bounded source-authority slices
are complete for `hair-bob`, `hair-short`, `hair-bun`, and `hair-ponytail`: each three-facing canonical set
...
a Bob, Short, Bun, or Ponytail path builder. The other six mapped styles still build their
