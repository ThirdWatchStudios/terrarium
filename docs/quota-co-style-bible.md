...
> cross-junction `mask_15` are also accepted: 18 direct, fourteen derived, fifteen synthetic cross-junction
...
- Accepted mapping law (owner approvals, 2026-07-21 through 2026-07-22): preserve the canonical 47-mask order and its explicit
  resolution split—18 direct reuse, 14 approved derivation, 15 proof-only synthetic cross-junction assemblies,
  0 collisions.
...
4. Keep `npm run style:watch` running (§10) — every save re-validates through the real importer and
   ...
   **current-state decision surface**: the accepted open-pocket `mask_15` cross-junction gate appears first,
   followed by the accepted horizontal partial T-junction gate, then
   ...
   15 synthetic cross-junction assembly rows remain unaccepted, and accepted pieces remain the
