...
export const DEFAULT_PROPS: PropInstance[] = [
  {
    ...
    params: { height: 56 },
    palette: { primary: '#DED5BD', secondary: '#355247', accent: '#B65F4D' },
  },
  {
    id: 'prop-printer',
    name: 'Printer',
  ...
  },
  {
    ...
    params: { bushiness: 2 },
    palette: { primary: '#527A45', secondary: '#355B34', accent: '#B65F4D' },
  },
  {
    id: 'prop-potted-tree',
    name: 'Potted tree',
    ...
    palette: { primary: '#3F7250', secondary: '#355247', accent: '#B65F4D' },
  },
  {
  ...
  },
  {
    ...
    templateId: 'copier',
    params: { height: 70 },
    palette: { primary: '#DED5BD', secondary: '#49685A', accent: '#B65F4D' },
  },
  {
    id: 'prop-shredder',
    name: 'Paper shredder',
  ...
  },
  {
    ...
    palette: { primary: '#262B29', secondary: '#355247', accent: '#B65F4D' },
  },
  {
  ...
  },
  {
    ...
    templateId: 'bean-bag',
    params: { size: 42 },
    palette: { primary: '#355247', secondary: '#18211E', accent: '#B65F4D' },
  },
  {
    id: 'prop-fish-tank',
    name: 'Fish tank',
  ...
  },
  {
    ...
    params: { bulbs: 6 },
    palette: { primary: '#DED5BD', secondary: '#262B29', accent: '#B65F4D' },
  },
  {
    id: 'prop-bar-cart',
    name: 'Bar cart',
  ...
  },
  {
    ...
    params: {},
    palette: { primary: '#F3EEDA', secondary: '#355247', accent: '#B65F4D' },
  },
  {
    id: 'prop-lamp-post',
  ...
  // silhouettes keep a scattered field from repeating one generic sprite.
  {
    id: 'prop-tree',
    name: 'Tree',
    templateId: 'tree-canopy',
    params: { habit: 0, lobes: 7, seed: 3 },
    palette: { primary: '#527A45', secondary: '#355B34', accent: '#6D8D57' },
  },
  {
    id: 'prop-tree-b',
    name: 'Tree warm',
    templateId: 'tree-canopy',
    params: { habit: 1, lobes: 7, seed: 7 },
    palette: { primary: '#527A45', secondary: '#355B34', accent: '#6D8D57' },
  },
  {
    id: 'prop-tree-upright',
    name: 'Tree upright',
    templateId: 'tree-canopy',
    params: { habit: 2, lobes: 6, seed: 1 },
    palette: { primary: '#527A45', secondary: '#355B34', accent: '#6D8D57' },
  },
  {
    id: 'prop-tree-conifer',
    name: 'Tree conifer',
    templateId: 'tree-canopy',
    params: { habit: 3, lobes: 7, seed: 9 },
    palette: { primary: '#527A45', secondary: '#355B34', accent: '#6D8D57' },
  },
  {
    ...
    params: { habit: 0, seed: 5 },
    palette: { primary: '#63A844', secondary: '#47822E', accent: '#96D468' },
  },
  {
    id: 'prop-tree-sapling-b',
    name: 'Sapling multi-stem',
    templateId: 'tree-sapling',
    params: { habit: 1, seed: 9 },
    palette: { primary: '#579A45', secondary: '#396F30', accent: '#88C76B' },
  },
  {
    id: 'prop-bush-cluster',
    name: 'Bush cluster',
    templateId: 'bush-cluster',
    params: { habit: 0, bushes: 3, seed: 2 },
    palette: { primary: '#3F7A2E', secondary: '#2C5C1F', accent: '#6FB04A' },
  },
  {
    id: 'prop-bush-bramble',
    name: 'Bush bramble',
    templateId: 'bush-cluster',
    params: { habit: 1, bushes: 4, seed: 6 },
    palette: { primary: '#4E8138', secondary: '#315B25', accent: '#7BAE55' },
  },
  {
    id: 'prop-bush-low',
    name: 'Bush low spreading',
    templateId: 'bush-cluster',
    params: { habit: 2, bushes: 3, seed: 8 },
    palette: { primary: '#54883B', secondary: '#356328', accent: '#83B75A' },
  },
  {
    ...
    palette: { primary: '#4E9A3C', secondary: '#37752A', accent: '#E8C84A' },
  },
  {
    id: 'prop-tall-grass-clump',
    name: 'Tall grass clump',
    templateId: 'tall-grass-clump',
    params: { density: 2, seed: 4 },
    palette: { primary: '#6B9B45', secondary: '#456D32', accent: '#B5A65A' },
  },
  {
    id: 'prop-bracken-patch',
    name: 'Bracken patch',
    templateId: 'bracken-patch',
    params: { fronds: 6, seed: 7 },
    palette: { primary: '#568844', secondary: '#345F31', accent: '#88A85D' },
  },
  {
    id: 'prop-boulder',
    name: 'Boulder',
...
export const DEFAULT_GROUND: TileInstance[] = [
  ...
  },
  {
    ...
    palette: { primary: '#4E9A3C', secondary: '#326D2B', accent: '#71B557' },
  },
  {
    id: 'ground-grass-c',
    name: 'Soft field grass',
    templateId: 'grass',
    params: { blades: 1, flowers: 1, seed: 2 },
    palette: { primary: '#4E9A3C', secondary: '#3A7431', accent: '#79B861' },
  },
  {
    id: 'ground-meadow',
    ...
    palette: { primary: '#4E9A3C', secondary: '#3F7534', accent: '#86BE61' },
  },
  {
    id: 'ground-meadow-b',
    name: 'Seed-head meadow',
    templateId: 'meadow',
    params: { flowers: 1, seed: 9 },
    palette: { primary: '#4E9A3C', secondary: '#427239', accent: '#8DBA68' },
  },
  {
    id: 'ground-dirt',
    name: 'Bare dirt',
