...
- `low-e-straight.svg`
- `low-se-corner.svg`
- `transition-n-to-e-base.svg`
- `transition-n-to-e-upper.svg`
...
The prior topology base was only the green lower chassis: outer `94..120`,
...
proof metadata; Unity retains composition, cutaways, sorting, lighting, and
