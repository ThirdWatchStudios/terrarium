...
export function validateEqualHeightThickWallHorizontalRepeatGate(
  ...
  if (
    ...
    EQUAL_HEIGHT_MASK_LEDGER.counts['direct-reuse'] !== 10 ||
    EQUAL_HEIGHT_MASK_LEDGER.counts['approved-derivation'] !== 9 ||
    EQUAL_HEIGHT_MASK_LEDGER.counts['synthetic-assembly'] !== 28 ||
