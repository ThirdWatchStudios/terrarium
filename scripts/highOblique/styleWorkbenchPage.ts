...
export const ACCEPTED_MAPPING_GATE: AcceptedSystemGate = {
  ...
  summary: 'Accepted topology map: 27 direct reuses, 18 approved derivations, 2 synthetic cross-junction candidates, and 0 authored-geometry gaps.',
...
/** The current owner-accepted equal-height decision sheets. */
...
export function renderStyleWorkbenchPage(diagnosticStems: readonly string[]): string {
  ...
  const acceptedDoubleFilledNorthCrossJunctionStatus =
    ...
    '<p>mask_39 directly reuses one west-fixed authored four-way union; both northern diagonals are solid and the two southern crooks remain open floor.</p></div>';
  ...
  const acceptedDoubleFilledWestCrossJunctionStatus =
    ...
    '<p>mask_43 is the accepted plain whole-cell X mirror of mask_25; both west crooks are solid and the two east crooks remain open floor.</p></div>';
  const acceptedDoubleFilledEastCrossJunctionStatus =
    ...
    '<p>mask_25 directly reuses one west-fixed authored union; both east crooks are solid and the two west crooks remain open floor.</p></div>';
  ...
  const acceptedSingleFilledCrossJunctionStatus =
    ...
    '<p>mask_19 directly reuses one west-fixed authored four-way union; the northeast crook is solid and the other three remain open floor.</p></div>';
  ...
  const acceptedHorizontalPartialTJunctionStatus =
    ...
    '<p>mask_18/mask_22 are direct; mask_35/mask_28 are approved X derivations. South-face plane-cue continuity remains deferred family-wide polish.</p></div>';
  ...
  const acceptedMappingGateStatus = '<div class="status-card accepted"><span>Accepted system mapping</span>' +
    ...
    '<p>The 47-row topology plan is locked; its 2 remaining synthetic cross-junction candidates remain proof-only.</p></div>';
  ...
  return (
    ...
    '<p class="lede">No wall proposal is currently active. mask_33 is accepted as one authored single-open northwest cross-junction; the proof ledger stands at 27 direct / 18 derived / 2 synthetic.</p></header>' +
