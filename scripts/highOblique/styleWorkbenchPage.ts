...
export const ACCEPTED_MAPPING_GATE: AcceptedSystemGate = {
  ...
  summary: 'Accepted topology map: 27 direct reuses, 19 approved derivations, 1 synthetic cross-junction candidate, and 0 authored-geometry gaps.',
...
const acceptedSystemGate = (
  ...
  refreshGroup: 'single-open-northeast-cross-junction' | 'single-open-northwest-cross-junction' | 'single-open-southeast-cross-junction' | 'single-open-southwest-cross-junction' | 'double-filled-south-cross-junction' | 'double-filled-opposite-diagonal-cross-junction' | 'double-filled-diagonal-cross-junction' | 'double-filled-north-cross-junction' | 'single-filled-northwest-cross-junction' | 'single-filled-southwest-cross-junction' | 'double-filled-west-cross-junction' | 'double-filled-east-cross-junction' | 'single-filled-southeast-cross-junction' | 'single-filled-cross-junction' | 'open-pocket-cross-junction' | 'horizontal-partial-t-junction' | 'east-partial-t-junction' | 'single-filled-pocket-t-junction' | 'horizontal-open-pocket-t-junction' | 'open-pocket-t-junction' | 'thick-wall-horizontal-repeat' | 'thick-wall-repeat' | 'thick-wall-block' | 'isolated-shell' | 'vertical-terminus' | 'terminus' | 'mapping' | 'corridor',
  gateId: 'single-open-northeast-cross-junction' | 'single-open-northwest-cross-junction' | 'single-open-southeast-cross-junction' | 'single-open-southwest-cross-junction' | 'double-filled-south-cross-junction' | 'double-filled-opposite-diagonal-cross-junction' | 'double-filled-diagonal-cross-junction' | 'double-filled-north-cross-junction' | 'single-filled-northwest-cross-junction' | 'single-filled-southwest-cross-junction' | 'double-filled-west-cross-junction' | 'double-filled-east-cross-junction' | 'single-filled-southeast-cross-junction' | 'single-filled-cross-junction' | 'open-pocket-cross-junction' | 'horizontal-partial-t-junction' | 'east-partial-t-junction' | 'single-filled-pocket-t-junction' | 'horizontal-open-pocket-t-junction' | 'open-pocket-t-junction' | 'thick-wall-horizontal-repeat' | 'thick-wall-repeat' | 'thick-wall-block' | 'isolated-shell' | 'vertical-terminus' | 'terminus' | 'mapping' | 'corridor',
): string => (
...
export function renderStyleWorkbenchPage(diagnosticStems: readonly string[]): string {
  ...
  const acceptedMappingGateStatus = '<div class="status-card accepted"><span>Accepted system mapping</span>' +
    ...
    '<p>The 47-row topology plan is locked; its 1 remaining synthetic cross-junction candidate remains proof-only.</p></div>';
  ...
  return (
    ...
    '<p class="lede">No wall proposal is currently active. mask_45 is accepted as the plain whole-cell X companion to mask_33; the proof ledger stands at 27 direct / 19 derived / 1 synthetic.</p></header>' +
